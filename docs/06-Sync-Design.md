...
### 已实施方案：**Supabase** (v1.7.0)

> [!NOTE]
> 该方案已于 2026-01-19 正式上线。详细的最终实现细节请参考：
> [Supabase 后端设计与实现 (2026-01-19)](file:///D:/my-projects/vocab-context/docs/plans/2026-01-19-supabase-backend-design.md)

**同步特性**：
- ✅ **全量同步**: 设置、进度、SRS、单词本、历史、成就。
- ✅ **多种认证**: GitHub 一键登录 & Email Magic Link。
- ✅ **离线优先**: 自动合并本地与云端数据。
